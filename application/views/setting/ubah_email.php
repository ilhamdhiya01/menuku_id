                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column">
                                <li class="nav-item"><a href="<?= base_url('setting/ubah_password'); ?>" class="nav-link"><i class="fas fa-key"></i> Ubah Password</a></li>
                                <li class="nav-item"><a href="<?= base_url('setting/ubah_email'); ?>" class="nav-link active"><i class="fas fa-envelope"></i> Ubah Email</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Email saat ini</label>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <span class="text-danger"><?= form_error('email1'); ?></span>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary float-right mr-5"><i class="far fa-edit"></i> Ubah Email</button>
                            </form>
                        </div>
