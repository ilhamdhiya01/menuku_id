    ...
    <section class="section">
        <div class="section-header" style="box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.5);">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?= base_url('member'); ?>">Dashboard</a></div>
                <div class="breadcrumb-item"><?= ucwords($menu); ?></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Menu <?= ucwords($menu); ?></h2>
            <p class="section-lead">
                Organize and adjust <?= ucwords($menu); ?> about this site.
            </p>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('setting/ubah_password'); ?>" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('setting/ubah_email'); ?>" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
