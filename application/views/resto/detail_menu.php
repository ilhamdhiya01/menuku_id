                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <div class="card" style="width: 18rem;">
                                        <img src="<?= base_url('public/img/profile/' . $detail['gambar']); ?>" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title">Keterangan</h5>
                                            <span class="card-text"><?= $detail['keterangan']; ?></span>
                                        </div>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item"><?= $detail['nama_makanan']; ?></li>
                                            <li class="list-group-item">Rp <?= number_format($detail['harga'],2,',','.'); ?></li>
                                            <li class="list-group-item"><?= $detail['status']; ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
